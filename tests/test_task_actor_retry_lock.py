"""Tests for actor redis lock and failure handling behavior."""
...
def test_run_task_marks_failed_without_auto_retry_on_stage_error():
...
def test_run_task_marks_dynamic_failed_after_dynamic_failure():
    task = SimpleNamespace(
    ...
    assert task.failure_reason == "transient dynamic failure"
    send_with_options.assert_not_called()
